...
// import { useLocation, useParams } from "react-router-dom"; // Import useHistory from react-router-dom
...
//     // console.log("2", popularPosts);
//     console.log("3", popularSongs);
//     console.log("4", popularPlace);
//     console.log("5", popularPpler);
